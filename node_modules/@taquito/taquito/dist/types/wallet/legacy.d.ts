...
export declare class LegacyWalletProvider implements WalletProvider {
    ...
    mapOriginateParamsToWalletParams(params: () => Promise<WalletOriginateParams>): Promise<import("@taquito/taquito/dist/types/operations/types").withKind<WalletOriginateParams<any>, OpKind.ORIGINATION>>;
